...
Output:
![image](https://github.com/user-attachments/assets/ce57d2aa-fec0-4eb3-9842-5101e9a30eec)

Result:
Hence, the Wumpus World Problem demonstrating Inferences from Propositional Logic is solved successfully using Python.
